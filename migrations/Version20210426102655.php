 ...
 */
final class Version20210426102655 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE competiton_equipe (equipe_id INT NOT NULL, competiton_id INT NOT NULL, INDEX IDX_EC62B3AD6D861B89 (equipe_id), INDEX IDX_EC62B3AD626A3C22 (competiton_id), PRIMARY KEY(equipe_id, competiton_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
