 ...
 */
final class Version20210407133242 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE general_user_equipe (general_user_id INT NOT NULL, equipe_id INT NOT NULL, INDEX IDX_C6603DD8D64E7EE1 (general_user_id), INDEX IDX_C6603DD86D861B89 (equipe_id), PRIMARY KEY(general_user_id, equipe_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE equipe_general_user (equipe_id INT NOT NULL, general_user_id INT NOT NULL, INDEX IDX_F349844D6D861B89 (equipe_id), INDEX IDX_F349844DD64E7EE1 (general_user_id), PRIMARY KEY(equipe_id, general_user_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
