 ...
 */
class getMentorRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MentorRepository' shared autowired service.
     *
     * @return \App\Repository\MentorRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MentorRepository.php';

        return $container->privates['App\\Repository\\MentorRepository'] = new \App\Repository\MentorRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
