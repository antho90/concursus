 ...
 */
class getGeneralUserRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\GeneralUserRepository' shared autowired service.
     *
     * @return \App\Repository\GeneralUserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GeneralUserRepository.php';

        return $container->privates['App\\Repository\\GeneralUserRepository'] = new \App\Repository\GeneralUserRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
