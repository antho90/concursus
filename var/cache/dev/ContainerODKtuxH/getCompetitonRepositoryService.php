 ...
 */
class getCompetitonRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CompetitonRepository' shared autowired service.
     *
     * @return \App\Repository\CompetitonRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CompetitonRepository.php';

        return $container->privates['App\\Repository\\CompetitonRepository'] = new \App\Repository\CompetitonRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
